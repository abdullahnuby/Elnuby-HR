...
if (!core.includes('SECTOR_MANAGER')) throw new Error('SECTOR_MANAGER is not represented in scope core');
if (core.includes('SITE_SUPERVISOR')) throw new Error('SITE_SUPERVISOR is retired');
