...
const navByRole = (role: string) =>
  [
    { id: 'dashboard', label: 'لوحة التحكم', icon: '⌂' },
    {
      ...
      label: 'الموظفون',
      icon: '♙',
      roles: ['SUPER_ADMIN', 'HR_MANAGER', 'PROJECT_MANAGER'],
    },
    {
      id: 'projects',
      label: 'المشاريع',
...
export default function Home() {
  ...
  async function createAccount() {
    ...
    try {
      ...
      setNotice(
        newRole === 'PROJECT_MANAGER'
          ? 'تم إنشاء الحساب وربطه بالمشروع وتسجيله كمدير للمشروع ومنحه الصلاحيات تلقائياً'
          : newRole === 'HR_MANAGER'
      ...
      <div className="panel-head">
        <div>
          ...
          <p>
            ...
            وتظهر العلاقة هنا وفي Google Sheets.
          </p>
        </div>
    ...
    <section className="panel page-panel">
      <div className="panel-head">
        <div>
          ...
          <p>
            إعدادات أساسية سيتم ربطها بجدول
            SETTINGS في Google Sheets.
          </p>
        </div>
      </div>
