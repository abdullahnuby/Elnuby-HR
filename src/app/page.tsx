...
export default function Home(){
 ...
 setNotice('تم إرسال طلب الإذن');setPermissionStart('');setPermissionEnd('');setPermissionReason('');}catch(e:any){setError(e.message)}finally{setBusy(false)}}
...
function ManagerDashboard({me,dash,managerDash,roleLabels,setSection}:any){
 ...
 return <>
  {managerDash?.assignmentMissing&&<div className="alert danger">هذا الحساب مدير مشروع لكنه غير مربوط بأي مشروع. من حساب مدير النظام افتح «حسابات المستخدمين» ثم «ربط مدير مشروع بمشروع» واحفظ المشروع، وبعدها أعد تحميل الصفحة.</div>}
