...
export default function Settings({role='HR_MANAGER'}:{role?:string}){
 ...
 return <section className="panel page-panel hr-settings">
  <div className="hr-settings-hero"><div><div className="eyebrow">ELNUBY HR • مركز التحكم</div><h2>إعدادات النظام</h2><p>قواعد التشغيل ولوائح الإجازات ومركز Excel في مكان واحد.</p></div><div className="hr-system-status"><span className="status-dot"/> النظام متصل</div></div>
